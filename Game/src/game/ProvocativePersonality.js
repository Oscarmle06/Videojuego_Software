// ProvocativePersonality.js
import { Personality } from "./Personality.js";
export class ProvocativePersonality extends Personality {
    constructor() {
        super("provocative", 30, 0.3);
        this.blockFrame = 0;
    }
    ...
    getInput(kart, track) {
        ...
        if (playerInfo.dist < 15) {
            ...
            if (checkpoint) {
                ...
                const desperation = (1 - Math.min(playerInfo.dist / 4, 1));
